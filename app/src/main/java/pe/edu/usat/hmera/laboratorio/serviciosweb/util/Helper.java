...
public class Helper {
    public static final String APP_NAME = "INTELECT - WEB SERVICE";
    //public static final String BASE_URL_WS = "http://10.0.2.2:3007";
    public static final String BASE_URL_WS = "http://192.168.18.9:4005";
    ...
    public String requestHttpPost(String requestURL, HashMap<String, String> postDataParams) throws JSONException {
        ...
        try {
            ...
            conn.setRequestProperty("Authorization", "Bearer "+postDataParams.get("token"));
